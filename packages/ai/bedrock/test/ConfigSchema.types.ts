...
export type BedrockFields = Assert<Equivalent<keyof Omit<ModelConfig, "toolHistory">, keyof NativeConfig>>
type NestedKeys<T> = { [K in keyof T]-?: keyof NonNullable<T[K]> }
export type BedrockNestedFields = Assert<
  Equivalent<NestedKeys<Omit<ModelConfig, "toolHistory">>, NestedKeys<NativeConfig>>
>
